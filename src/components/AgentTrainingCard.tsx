...
export const AgentTrainingCard: React.FC<AgentTrainingCardProps> = ({
  ...
  return (
    <div className={isActive 
      ? "mb-6 relative rounded-lg overflow-hidden" 
      : "mb-6 border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden"
    }>
      {isActive && (
        <div className="absolute inset-0 rounded-lg p-[1px] bg-gradient-active pointer-events-none" />
      )}
      <div className="bg-white dark:bg-gray-950 rounded-lg relative z-10">
